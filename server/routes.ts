  ...
  app.post("/api/export/sheets/full", async (_req: Request, res: Response) => {
    try {
      ...
      const overviewRows = [
        ...
        [""],
        ["=== CORE FEATURES ==="],
        ["1. Age-Tiered Quiz System - Mini (20Q), Teen (30Q), Young Adult (35Q), Adult (40Q)"],
        ...
        ["5. Premium Features - 7 swipeable insight cards (career sim, side hustles, growth quests, learning styles, etc.)"],
