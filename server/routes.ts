  ...
  app.post("/api/export/sheets/full", async (_req: Request, res: Response) => {
    try {
      ...
      const overviewRows = [
        ...
        ["2. Mood Selection & Mood Mixer - Personalized journey based on emotional state, mood boosts applied to Big Five traits"],
        ...
        ["5. Comprehensive Results - MBTI, DISC, Big Five personality profiles with percentile comparisons"],
        ["6. Premium Features - 8 swipeable insight cards (career sim, side hustles, growth quests, learning styles, etc.)"],
        ["7. Sharpen Thinking Section - ADAPTIVE: prioritizes weak proxies (critical vs firstPrinciples), tracks progress in localStorage"],
        ["8. Achievement Badges - 8 badge types awarded based on quiz behavior"],
        ["9. Random Event Pop-ups - 8-15% chance per question with engagement-based dynamic calculation"],
        ...
        ["12. Mid-Quiz Recaps - Every 10 questions shows running trait tendencies"],
        ["13. PDF Download - Share results as printable PDF via browser print dialog"],
        ["14. Percentile Comparisons - Big Five scores compared to population norms using z-scores"],
        [""],
        ["=== USER JOURNEY FLOW ==="],
      ...
      const algorithmRows = [
        ...
        ["7-12", "Mini Explorer (12 & under)", "16", "10s", "5 → MC1 → 4 → Superpower → 4 → Mystery → 3 → MC2"],
        ["13-18", "Teen (Ages 13-18)", "22", "10s", "7 → MC1 → 6 → Superpower → 5 → Mystery → 4 → MC2"],
        ["19-25", "Young Adult (Ages 19-25)", "28", "9s", "8 → MC1 → 7 → Superpower → 7 → Mystery → 6 → MC2"],
        ["25+", "Adult (Ages 25+)", "34", "9s", "9 → MC1 → 9 → Superpower → 9 → Mystery → 7 → MC2"],
        [""],
        ["╔══════════════════════════════════════════════════════════════════╗"],
        ...
        [""],
        ["╔══════════════════════════════════════════════════════════════════╗"],
        ["║  MOOD INTEGRATION (December 2025)                                ║"],
        ["╚══════════════════════════════════════════════════════════════════╝"],
        [""],
        ["Mood effects apply boosts to Big Five traits:"],
        [""],
        ["Mood", "Trait Boost", "Amount"],
        ["Stuck", "Critical Thinking", "+10%"],
        ["Reflective", "First Principles", "+5%"],
        ["Energized", "Openness", "+5%"],
        ["Reflective+Stuck (blend)", "Both Critical & First Principles", "+7% each"],
        [""],
        ["Implementation: getMoodEffects() in Quiz.tsx and routes.ts"],
        ...
        ["╚══════════════════════════════════════════════════════════════════╝"],
        [""],
        ["Every 10 questions, users see a running summary of their trait tendencies:"],
        [""],
        ["Recap Trigger", "Content Shown", "Duration"],
        ["Question 10, 20, 30", "Top 2 emerging traits with friendly descriptions", "Auto-dismiss after 3s"],
        [""],
        ["Example: 'Looking curious and creative so far!'"],
        [""],
        ["╔══════════════════════════════════════════════════════════════════╗"],
      ...
      const premiumInsightsRows = [
        ...
        ["╚══════════════════════════════════════════════════════════════════╝"],
        [""],
        ["The Premium Insights System provides 8 categories of personalized insights"],
        ...
        ["Display: 8 swipeable cards in PremiumCardDeck.tsx component"],
        ["Matching: Server-side trait matching via /api/premium-insights endpoint"],
        [""],
        ["╔══════════════════════════════════════════════════════════════════╗"],
        ["║  8 PREMIUM INSIGHT CATEGORIES                                     ║"],
        ["╚══════════════════════════════════════════════════════════════════╝"],
        [""],
        ["#", "Category", "Database Table", "Icon", "Description"],
        ["1", "Side Hustles", "side_hustles", "DollarSign", "Income opportunities matched to personality"],
        ["2", "Blindspots", "blindspots", "Eye", "Growth areas based on low trait scores"],
        ["3", "Career Paths", "career_paths", "Briefcase", "Extended career recommendations"],
        ["4", "Growth Tips", "growth_tips", "TrendingUp", "Personalized improvement suggestions"],
        ["5", "Strengths", "strengths", "Star", "High-trait strength descriptions"],
        ["6", "Communication", "communication_styles", "MessageSquare", "Communication style analysis"],
        ["7", "Work Environments", "work_environments", "Building", "Ideal workplace settings"],
        ["8", "Relationships", "relationship_insights", "Heart", "How traits affect relationships"],
        [""],
        ["╔══════════════════════════════════════════════════════════════════╗"],
        ...
        ["PremiumCardDeck", "Main container with 8 swipeable cards"],
        ...
        ["Progress Dots", "8 dots showing current position in deck"],
