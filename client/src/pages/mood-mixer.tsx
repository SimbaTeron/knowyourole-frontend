      ...
      <main className="relative z-10 pt-16 pb-32 px-4 min-h-screen flex flex-col text-[20px]">
        <div className="max-w-md mx-auto w-full flex-1 flex flex-col">
          ...
          >
            ...
            <p className="text-warm-gray/70 dark:text-soft-cream/60 max-w-sm mx-auto text-[18px]">Tap two to create your mood blend or continue below. This helps us personalize your journey.</p>
          </motion.div>
