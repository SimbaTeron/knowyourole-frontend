  ...
  return (
    <div className="orbital-results-v2" style={orbStyle}>
      ...
      <style>{`
        ...
        .portrait-card { position:relative; overflow:hidden; border:1px solid rgba(255,255,255,.18); border-radius:34px; padding:18px; min-height:560px; background:radial-gradient(circle at 84% 8%, rgba(82,241,255,.27), transparent 34%), radial-gradient(circle at 4% 86%, rgba(255,213,129,.13), transparent 34%), linear-gradient(150deg, rgba(255,255,255,.12), rgba(255,255,255,.035)); box-shadow:0 24px 80px rgba(0,0,0,.36), inset 0 1px 0 rgba(255,255,255,.16); backdrop-filter:blur(22px); }
        ...
        .link-stack { margin-top:14px; display:grid; gap:10px; } .result-link { width:100%; text-align:left; display:grid; grid-template-columns:44px minmax(0,1fr) auto; gap:11px; align-items:center; padding:13px; border-radius:22px; border:1px solid rgba(255,255,255,.13); color:white; background:linear-gradient(135deg,rgba(255,255,255,.105),rgba(255,255,255,.04)); box-shadow:0 12px 30px rgba(0,0,0,.16); cursor:pointer; } .icon { width:44px; height:44px; border-radius:16px; display:grid; place-items:center; background:rgba(255,255,255,.09); border:1px solid rgba(255,255,255,.11); font-size:21px; } .result-link b { display:block; font-size:15px; letter-spacing:-.03em; } .result-link span span { display:block; color:var(--muted); font-size:12px; line-height:1.28; margin-top:2px; } .arrow { color:var(--faint); font-size:22px; }
        ...
        {view === "main" && (
          <section>
            ...
            <div className="link-stack">
              ...
              <button className="result-link" onClick={() => go("mbti")}><span className="icon">♟</span><span><b>MBTI</b><span>Your cognitive operating system.</span></span><span className="arrow">›</span></button>
              ...
              <button className="result-link" onClick={() => go("share")}><span className="icon">↗</span><span><b>Share</b><span>Export image/PDF or send by text/email.</span></span><span className="arrow">›</span></button>
            </div>
          </section>
        )}
