...
export default function CheckoutSuccess() {
  ...
  useEffect(() => {
    // Read URL params safely on client only
    const params = new URLSearchParams(window.location.search);
    setSessionId(params.get('session_id'));
    setQuizSession(params.get('quiz_session'));
    setIsDonation(params.get('donation') === 'true');
  }, []);
  ...
  const handleContinueToResults = () => {
    router.push('/quiz?donation_return=true');
  };
